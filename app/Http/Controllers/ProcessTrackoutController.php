...
class ProcessTrackoutController extends Controller
{
    public function update(Request $request)
    {
        ...
        try {
            ...
            try {
                ...
                foreach ($lines as $i => $line) {
                    ...
                    if (count($batch) >= $batchSize) {
                        DB::table('process_trackout')->insert($batch);
            ...
            Log::info('Process Trackout data added', [
                'rows_inserted' => $totalInserted,
                'rows_skipped' => $skippedRows,
                'updated_by' => $updatedBy
            ]);

            return back()->with('success', 'Process Trackout data added successfully!');

        } catch (\Exception $e) {
            Log::error('Process Trackout update failed', [
                'error' => $e->getMessage(),
    ...
    public function downloadTemplate()
    {
        ...
        return response($content)
            ...
            ->header('Content-Disposition', 'attachment; filename="process_trackout_template.txt"');
    }
