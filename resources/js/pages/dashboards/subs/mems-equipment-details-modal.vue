            ...
            <DialogHeader class="px-5 py-3 border-b border-border bg-gradient-to-r from-cyan-50 to-cyan-100/50 dark:from-cyan-950/30 dark:to-cyan-900/20">
                <DialogTitle class="flex items-center gap-3">
                    ...
                    <div>
                        ...
                        <p class="text-xs text-muted-foreground mt-0.5">{{ equipment?.eqp_no }}</p>
                    </div>
                </DialogTitle>
                ...
                <div class="rounded-lg border-2 border-green-400 dark:border-green-600 overflow-hidden">
                    ...
                    <div class="p-3 bg-green-50/50 dark:bg-green-900/20 grid grid-cols-5 gap-3">
                        <div>
                            ...
                            <p class="font-bold text-green-700 dark:text-green-300">{{ formatNumber(equipment.loading_speed) }} <span class="text-xs font-normal">units/min</span></p>
                        </div>
                        <div>
                            <span class="text-xs text-gray-500 dark:text-gray-400">Operation Time:</span>
                            <p class="font-bold text-green-700 dark:text-green-300">{{ formatNumber(equipment.operation_time) }} <span class="text-xs font-normal">min</span></p>
                        </div>
                        <div>
                            <span class="text-xs text-gray-500 dark:text-gray-400">OEE:</span>
                            <p class="font-bold text-green-700 dark:text-green-300">{{ formatDecimal(equipment.eqp_oee) }}</p>
                        </div>
                        <div>
                            <span class="text-xs text-gray-500 dark:text-gray-400">Passing:</span>
                            <p class="font-bold text-green-700 dark:text-green-300">{{ formatDecimal(equipment.eqp_passing) }}</p>
                        </div>
                        <div>
                            <span class="text-xs text-gray-500 dark:text-gray-400">Yield:</span>
                            <p class="font-bold text-green-700 dark:text-green-300">{{ formatDecimal(equipment.eqp_yield) }}</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="rounded-lg border-2 border-cyan-400 dark:border-cyan-600 overflow-hidden">
                    ...
                    <div class="p-3 bg-cyan-50/50 dark:bg-cyan-900/20 grid grid-cols-3 gap-3">
                        <div class="text-center p-3 rounded bg-cyan-100 dark:bg-cyan-800/30">
                            ...
                            <p class="text-2xl font-bold text-cyan-700 dark:text-cyan-300">{{ formatNumber(equipment.ideal_capa) }}</p>
                            <span class="text-xs text-gray-500">{{ formatCapacity(equipment.ideal_capa) }}</span>
                        ...
                        <div class="text-center p-3 rounded bg-blue-100 dark:bg-blue-800/30">
                            ...
                            <p class="text-2xl font-bold text-blue-700 dark:text-blue-300">{{ formatNumber(equipment.oee_capa) }}</p>
                            <span class="text-xs text-gray-500">{{ formatCapacity(equipment.oee_capa) }}</span>
                        ...
                        <div class="text-center p-3 rounded bg-emerald-100 dark:bg-emerald-800/30">
                            ...
                            <p class="text-2xl font-bold text-emerald-700 dark:text-emerald-300">{{ formatNumber(equipment.output_capa) }}</p>
                            <span class="text-xs text-gray-500">{{ formatCapacity(equipment.output_capa) }}</span>
